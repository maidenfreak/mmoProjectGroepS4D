  ...
  buildRoom(boxnum){
    if(this.roomnum!=19){
      if(this.visible==false){
        var map = document.getElementById("map"+(boxnum+1));
        context.drawImage(map, this.x, this.y);
      }
    }
  }
}
...
let wall47 = new object("wall47", 240, 215, 2, 25); wall47.pushToArray();
let wall48 = new object("wall48", 82, 240, 158, 2); wall48.pushToArray();
...
let wall26 = new object("wall26", 482,320,23,2); wall26.pushToArray();
let wall27 = new object("wall27", 535,320,50,2); wall27.pushToArray();
let wall29 = new object("wall29", 480,375,2,25); wall29.pushToArray();
let wall30 = new object("wall30", 402,400,158,2); wall30.pushToArray();
let wall31 = new object("wall31", 560,402,2,23); wall31.pushToArray();
...
let wall50 = new object("wall50", 82,480,105,2); wall50.pushToArray();
let wall51 = new object("wall51", 80,455,2,50); wall51.pushToArray();
let wall52 = new object("wall52", 80,535,2,105); wall52.pushToArray();
let wall53 = new object("wall53", 80,322,2,105); wall53.pushToArray();
...
let wall59 = new object("wall59", 162,400,78,2); wall59.pushToArray();
let wall60 = new object("wall60", 160,455,2,25); wall60.pushToArray();
let wall61 = new object("wall61", 160,295,2,55); wall61.pushToArray();
let wall62 = new object("wall62", 160,242,2,25); wall62.pushToArray();
